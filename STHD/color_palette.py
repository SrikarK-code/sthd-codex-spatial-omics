...
def _generate_color_palette(names, hue_range, saturation, lightness, hue_shift=0, color_format="rgb"):
...
def get_color_map_1(genemeanpd_filtered):
    ...
    tumor_colors = _generate_color_palette(names=names[:11], hue_range=[0, 0.2], saturation=0.8, lightness=1, hue_shift=0, color_format="hex")
    normal_colors = _generate_color_palette(names=names[11:], hue_range=[0.25, 0.8], saturation=0.7, lightness=0.7, hue_shift=0, color_format="hex")
